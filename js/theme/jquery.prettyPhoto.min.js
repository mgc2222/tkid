    ...
    a.prettyPhoto = {
        ...
        function g() {
            a(".pp_loaderIcon").hide(),
                projectedTop = scroll_pos.scrollTop + ((A < 641)? (A-200)/2 : A/2) - ((r.containerHeight + $pp_title.height() + $pp_pic_holder.find(".pp_top").height() + $pp_pic_holder.find(".pp_bottom").height()) / 2),
                projectedTop < 0 && (projectedTop = 0), $ppt.fadeTo(settings.animation_speed, 1), $pp_pic_holder.find(".pp_content").animate({
