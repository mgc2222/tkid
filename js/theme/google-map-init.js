...
//var map;
  ...
  google.maps.event.addListener(map, 'idle', function() {
    ...
    var content = '<div style="position: absolute; left: 0px; bottom: 25px;">\n' +
      ...
      '                        <a target="_blank" rel="noopener noreferrer" jstcache="53" href="https://maps.google.com/maps?q=Drumul+Vârful+Berivoiul+Mare+72a+București+Sector+1@'+latitude+','+longitude+'" class="navigate-link">\n' +
      ...
      '                    <div class="google-maps-link"> <a target="_blank" rel="noopener noreferrer" jstcache="46" href="https://maps.google.com/maps?q=Drumul+Vârful+Berivoiul+Mare+72a+București+Sector+1@'+latitude+','+longitude+'" jsaction="mouseup:placeCard.largerMap">View larger map</a> </div>\n' +
