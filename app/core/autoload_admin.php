...
include_once($relativePathInclude.'system/lib/session/session.php');
include_once($relativePathInclude.'system/lib/form/form.php');
require_once($relativePathInclude.'system/lib/form/html_controls.php');
include_once($relativePathInclude.'system/lib/utils/string_utils.php');

// include auth library
include_once($relativePathInclude._APPLICATION_FOLDER.'lib/auth/auth.php');

// include menu class
include_once($relativePathInclude._APPLICATION_FOLDER.'lib/menu/menu.php');
...
include_once($relativePathInclude._APPLICATION_FOLDER.'controllers/admin_controller.php');
