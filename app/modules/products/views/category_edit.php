...
<div class="grid_buttons"><?php echo HtmlControls::GenerateFormButtons($trans['general.save'], 'frm.FormSaveData()', $webpage->PageReturnUrl, $trans['categories.items_list'])?>
<?php if ($dataView->EditId != 0) 
	{ 
		echo HtmlControls::GenerateNewItemButton('categories', $trans['categories.new_item']);
	} ?> 
</div>
<div class="edit_wrapper">
<table class="edit_table">
	<tr>
		<td class="required"><?php echo $trans['categories.name']?>: </td>
	...
	<tr>
		<td class="required"><?php echo $trans['categories.parent']?>:</td>
		<td>
	...
	<tr>
		<td><?php echo $trans['categories.is_active']?>: </td>
