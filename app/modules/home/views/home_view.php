...
//include(dirname(__FILE__).'/../'.'blocks/section_upcoming_events.php'); 
//include(dirname(__FILE__).'/../'.'blocks/section_today_food.php'); 
//include(dirname(__FILE__).'/../'.'blocks/section_book_table.php'); 
//include(dirname(__FILE__).'/../'.'blocks/section_latest_news.php'); 
//include(dirname(__FILE__).'/../'.'blocks/section_customer_words.php'); 
?>
