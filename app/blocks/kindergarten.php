...
<article id="post-10" class="post-10 page type-page status-publish hentry mhmm">
	<header class="entry-header">
        <h2 class="elementor-heading-title elementor-size-large entry-title" id="section-kindergarten">
            <?php echo $trans['kindergarten.section_title'];?>
		</h2>
	</header>
	<!-- .entry-header -->
											...
											<div data-id="p13nvpq" class="elementor-element elementor-element-p13nvpq elementor-widget elementor-widget-text-editor" data-settings="[]" data-element_type="text-editor.default">
												<div class="elementor-widget-container">
													<div class="elementor-text-editor elementor-clearfix">
                                                        <?php $arrContentKindergarten = (isset($transJson['category_id_'.$dataView->categoryContentKindergartenId])) ? $transJson['category_id_'.$dataView->categoryContentKindergartenId] : [] ;?>
                                                        <?php echo (isset($arrContentKindergarten['html'])) ? $arrContentKindergarten['html'] : '';?>
													</div>
												</div>
											</div>
										</div>
