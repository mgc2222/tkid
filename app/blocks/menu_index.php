                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="<?php echo ($rowParentArticle->default_image) ? 'col-md-9' : 'col-md-12' ?>  product-description">
                                            <div class="food-detail">
                                                ...
                                                <?php echo ($rowParentArticle->amount) ? ucwords($rowParentArticle->name).' ('.$rowParentArticle->amount.$rowParentArticle->amount_unit.')' : ucwords($rowParentArticle->name)?> 
                    ...
                    ?>
                                ...
                                ?>
                                        ...
                                        <div class="<?php echo ($rowsArticle->default_image) ? 'col-md-9' : 'col-md-12' ?>  product-description">
                                            <div class="food-detail">
                                                <span class="title clearfix">
                                                <?php echo ($rowsArticle->amount) ? ucwords($rowsArticle->name).' ('.$rowsArticle->amount.$rowsArticle->amount_unit.')' : ucwords($rowsArticle->name)?> 
                            ...
                            ?>
                                        ...
                                        ?>
                                                ...
                                                <div class="<?php echo ($rowArticle->default_image) ? 'col-md-9' : 'col-md-12' ?>  product-description">
                                                    <div class="food-detail">
                                                        <span class="title clearfix">
                                                        <?php echo ($rowArticle->amount) ? ucwords($rowArticle->name).' ('.$rowArticle->amount.$rowArticle->amount_unit.')' : ucwords($rowArticle->name) ?> 
                            ...
                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="<?php echo ($article->default_image) ? 'col-md-9' : 'col-md-12' ?>  product-description">
                                                        <div class="food-detail">
                                                            <span class="title clearfix">
                                                                <?php echo ($article->amount) ? ucwords($article->name).' ('.$article->amount.$article->amount_unit.')' : ucwords($article->name) ?> 
                                    ...
                                    ?>
                                                ...
                                                ?>
                                                        ...
                                                        <div class="<?php echo ($categArticle->default_image) ? 'col-md-9' : 'col-md-12' ?>  product-description">
                                                            <div class="food-detail">
                                                                <span class="title clearfix">
                                                                <?php echo ($categArticle->amount) ? ucwords($categArticle->name).' ('.$categArticle->amount.$categArticle->amount_unit.')' : ucwords($categArticle->name) ?> 
