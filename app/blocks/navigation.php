...
<div class="menu-main-menu-container">
    <ul id="primary-menu" class="menu">
        <li id="menu-item-30" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-20 current_page_item menu-item-has-children menu-item-30 menu-item-for-page-20">
            ...
            <ul class="sub-menu">
                <li id="menu-item-145" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-145 menu-item-for-page-143"> <a href="home-small-slider.html">Small Slider</a> </li>
            </ul>
        </li>
        ...
        <li id="menu-item-23" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-23 menu-item-for-page-10"> <a href="about.html">About</a> </li>
        <li id="menu-item-29" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-29 menu-item-for-page-12"> <a href="shop.html">Shop</a> </li>
        <li id="menu-item-24" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-24 menu-item-for-page-14"> <a href="blog.html">Blog</a> </li>
        <li id="menu-item-26" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-26 menu-item-for-page-16"> <a href="gallery.html">Gallery</a> </li>
        <li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-25 menu-item-for-page-18"> <a href="contact.html">Contact</a> </li>
    </ul>
</div>